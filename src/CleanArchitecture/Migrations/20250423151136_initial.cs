    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69db714f-9576-45ba-b5b7-f00649be01de"), 0, "0052c29f-6e5d-4ade-8f8b-87f16d5556d3", "admin@gmail.com", true, false, null, "Admin 1", "ADMIN@GMAIL.COM", "admin", "AQAAAAIAAYagAAAAEIjg+3swnusDuzYT4+XDLxNni+AVOUFhMvStKusKXMdVROxhENPfH41V9BH6k2RsqQ==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "Item",
                columns: new[] { "Id", "Category", "Description", "IsCompleted", "Priority", "Title" },
                values: new object[,]
                {
                    { 1, "", "Task 1 Description", false, 0, "Task 1" },
                    { 2, "", "Task 2 Description", false, 0, "Task 2" },
                    { 3, "", "Task 3 Description", false, 0, "Task 3" },
                    { 4, "", "Task 4 Description", false, 0, "Task 4" },
                    { 5, "", "Task 5 Description", false, 0, "Task 5" }
                });
